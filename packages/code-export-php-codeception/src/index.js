...
function generateTestDeclaration(name) {
  return `\npublic function ${exporter.parsers.camelCase(name)}(AcceptanceTester $I) {`
}

function generateMethodDeclaration(name) {
  return `\npublic function ${exporter.parsers.camelCase(name)}() {`
}


function generateSuiteDeclaration(name) {
  return `\nclass ${exporter.parsers.camelCase(name)}Cest {`
}
